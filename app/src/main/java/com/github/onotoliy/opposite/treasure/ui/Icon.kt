...
@Composable
fun IconChat(modifier: Modifier = Modifier, tint: Color = Color.Black) =
    Icon(imageVector = vectorResource(id = R.drawable.ic_baseline_chat_24), tint = tint, modifier = modifier)
