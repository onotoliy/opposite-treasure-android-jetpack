...
interface TransactionDAO: WriteDAO<TransactionVO> {
    ...
    @Query("SELECT * FROM treasure_transaction ORDER BY milliseconds DESC LIMIT :offset, :numberOfRows")
    ...
    @Query("SELECT * FROM treasure_transaction WHERE person_uuid = :person ORDER BY milliseconds DESC LIMIT :offset, :numberOfRows")
    ...
    @Query("SELECT * FROM treasure_transaction WHERE event_uuid = :event ORDER BY milliseconds DESC LIMIT :offset, :numberOfRows")
